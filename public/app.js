document.addEventListener('DOMContentLoaded', () => {
    ...
    fetchGlobalStats();
    fetchContinentStats();
    fetchPreviousDayStats(); // Ensure this is fetching correctly
  });
    ...
    fetch('/previousDayStats')
        ...
        .then(data => {
            ...
            const formattedData = Object.keys(data).map(continent => {
                ...
                return `${continent}: Happy: ${continentData.happy}, Sad: ${continentData.sad}, Excited: ${continentData.excited}, Angry: ${continentData.angry}`;
            }).join("<br>");
